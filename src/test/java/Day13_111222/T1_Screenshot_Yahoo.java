...
public class T1_Screenshot_Yahoo extends Reusable_Annotations_Loggers {
    ...
    public void tc001_verifySignedInOptionIsChecked() throws InterruptedException {
        ...
        //THIS IS WHERE WE MADE THE XPATH INCORRECT TO GET SCREENSHOT
        ReusableActions_Loggers.clickAction(driver,"//*[@class = '_yb_1933exx']",logger,"Sign In");
