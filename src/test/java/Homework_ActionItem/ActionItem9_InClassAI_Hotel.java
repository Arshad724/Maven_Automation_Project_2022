...
public class ActionItem9_InClassAI_Hotel {
    public static void main(String[] args) throws InterruptedException {
        ...
        for(int i=0; i< destination.size(); i++) {
            ...
            //reduce the adult number by 1. Initially at 2
            try {
            ...
            try {
                ...
                //click on add adults. The number of times to click is gotten from the adultPass array list.
            ...
            try {
                if (i == 0) {
                    //click on 3rd hotel package
                    driver.findElements(By.xpath("//*[@class='uitk-image-link']")).get(2).click();
                } else if (i == 1) {
                    //click on 1ST hotel package. THE 4TH ITERATION DIDNT WORK BECAUSE MAYBE IT HAD TO SCROLL DOWN
            ...
            try {
                ...
                System.out.println(timesSplit[0] + " " + timesSplit[1]);
                System.out.println(timesSplit[2]+ " " + timesSplit[3]);
            } catch (Exception e){
