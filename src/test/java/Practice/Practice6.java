...
public class Practice6 {
    ...
    public void zipCode() throws InterruptedException {
        ReusableActions.sendKeysAction(driver,"//*[@name='input']", "11218","enter zipCode");
        Thread.sleep(2000);
        ReusableActions.clickAction(driver, "//*[@type='submit']", "clicking continue");
        //   driver.findElement(By.xpath("//*[@name='input']")).sendKeys(Keys.ENTER);
 ...
 //       Thread.sleep(2000);
    ...
    public void captureDoctorDetails() throws InterruptedException {
        ReusableActions.selectByText(driver, "//*[@id='distance']", "Within 5 Miles", "selecting 5 mile");
        Thread.sleep(3000);
        driver.navigate().refresh();
        Thread.sleep(3000);
        ReusableActions.selectByText(driver, "//*[@id='distance']", "Within 5 Miles", "selecting 5 mile");
        ReusableActions.clickActionByIndex(driver, "//*[@class='sc-bXmHAB ITGjV providerName']/a",0,"clicking on first doctor");
        ...
        //String addressValue = ReusableActions.getTextActionByIndex(driver, "//*[@class= 'btn-label-wrapper']",0,"capturing address");
    ...
    public void captureSearchResult(){
        ...
        ReusableActions.sendKeysAction(driver,"//*[@id='search-desktop']","doctor","typing doctor");
