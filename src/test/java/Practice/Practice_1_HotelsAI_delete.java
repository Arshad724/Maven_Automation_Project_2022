...
public class Practice_1_HotelsAI_delete {
        ...
        for(int i=0; i< destination.size(); i++) {
            ...
            try {
                if (i == 0) {
                    ...
                    driver.findElements(By.xpath("//*[@class='uitk-image-link']")).get(7).click();
                } else if (i == 2) {
                    //click on 2nd hotel package
                    driver.findElements(By.xpath("//*[@class='uitk-image-link']")).get(4).click();
                }
            } catch (Exception e){
