...
public class Practice_2_MyOriginal_HotelAI_Code {
    public static void main(String[] args) throws InterruptedException {

        //THIS IS MY ORIGINAL CODE FOR THE HOTEL AI
        //THE ADULT ADDING CLICKING WAS CHANGED TO MARYAMS CODE
        //ADDED ANOTHER ARRAYLIST FOR CHILD AGE AND USED MARYAMS CODE TO APPLY IT
        ...
        for(int i=0; i< destination.size(); i++) {
            ...
            try {
                ...
                if (i == 0) {
                    //adding 1 to adult
                    for (int j = 0; j < adult.get(0); j++) {
                        adultPass.get(1).click();
                    }
                } else if (i == 1) {
                    for (int j = 0; j < adult.get(1); j++) {
                        adultPass.get(1).click();
                    }//end of adult 2click for loop
                } else if (i == 2) {
                    for (int j = 0; j < adult.get(2); j++) {
                        adultPass.get(1).click();
                    }//end of adult 3click for loop
            ...
            if(i==0) {
                ...
                try {
                    ...
                    Thread.sleep(2000);
                    Select childageDp = new Select(childAge);
                    childageDp.selectByVisibleText("5");
                ...
                try {
                    ...
                    Thread.sleep(2000);
                    Select childageDp = new Select(childAge);
                    childageDp.selectByVisibleText("8");

                } catch (Exception e) {
                    System.out.println("child error  " + e);
                }//end of catch
            }//end of if else for child age
            ...
            try {
                if (i == 0) {
                    ...
                    //click on 3rt hotel package
                    driver.findElements(By.xpath("//*[@class='uitk-image-link']")).get(1).click();
                } else if (i == 2) {
                    //click on 2nd hotel package
                    driver.findElements(By.xpath("//*[@class='uitk-image-link']")).get(2).click();
                }
            } catch (Exception e){
