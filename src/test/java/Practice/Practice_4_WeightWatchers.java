...
public class Practice_4_WeightWatchers {
    public static void main(String[] args) throws InterruptedException {

        //This code has the unedited version of the weightWatchers project
        ...
        for(int i=0; i< zipCode.size();i++) {
            ...
            System.out.println("The studio address for zipcode: "+ zipCode.get(i) +" is "+splitAddress[0]+ " " + splitAddress[1]);
            //wait 3 sec
            Thread.sleep(3000);
...
//            jse.executeScript("arguments[0].scrollIntoView(true);", studioSchedule);
            ...
            //just added message for looking nice
            String message = "and the schedule for the studio is:";
            System.out.println(message);
            for (int j = 0; j < schedule.size(); j++) {
                String hours = schedule.get(j).getText();
//            String[] hourSplit = hours.split(" ");
//            System.out.println(hourSplit[0]);
